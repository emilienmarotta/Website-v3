    ...
    if(i == 0) {
        ...
        if (statusMiage == 0) {
            ...
            if (language == "english") {
                ...
                divMiage.innerHTML = `<img onclick="change_content(${i})" class="about__box__intended-route__element__button" src="Index/back.png" alt="Back" style="width:35px" title=""><span></span><p style='z-index:8;color:#6495ed'><a href="https://idmc.univ-lorraine.fr/idmc-parcours-miage/">MIAGE</a></p><ul style='z-index:8;display:flex;flex-direction:column;justify-content:center;width:100%;margin-left:3%;'><li>Ingénierie Logicielle</li><li>Cloud Computing</li><li>Sciences des Données</li><li>Intelligence Artificielle</li><li>Informatique Décisionnelle</li><li>Gestion de Projet</li><li>Management des SI</li><li>Mathématiques Appliquées</li><li>Droit Informatique</li></ul>`;
            }
        } else {
            statusMiage = 0;
            if (language == "english") {
        ...
        if (statusMines == 0) {
            ...
            if (language == "english") {
                ...
                divMines.innerHTML = `<img onclick="change_content(${i})" class="about__box__intended-route__element__button" src="Index/back.png" alt="Back" style="width:35px" title=""><span></span><p style='z-index:8;color:#6495ed'><a href="https://mines-nancy.univ-lorraine.fr/formation/mastere-specialise-cybersecurite-attaque-defense-des-systemes-informatiques/">Cybersécurité</a></p><ul ${ulCSS}><li>Logiciels Malveillants</li><li>Rétro-Ingénierie</li><li>Sécurité Réseau</li><li>Cryptographie</li><li>Gestion de Crise</li><li>Politiques de Sécurité</li><li>Communications</li><li>Forensic</li><li>OS & Virtualisation</li></ul>`;
            }
        } else {
            statusMines = 0;
            if (language == "english") {
...
function translate_in_english() {
    ...
    if (mines__text !== undefined) {
        mines__text.innerHTML = "Specialised master's degree in Cybersecurity<br>(Bac+5 to Bac+6)";
    }
